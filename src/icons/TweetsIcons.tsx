...
export function Like({ size }: Props) {
  return (
    <svg
      viewBox="0 0 24 24"
      aria-hidden="true"
...
export function Retwitt({ size }: Props) {
  return (
    <svg
      viewBox="0 0 24 24"
      aria-hidden="true"
...
export function Share({ size }: Props) {
  return (
    <svg
      viewBox="0 0 24 24"
      aria-hidden="true"
...
export function CommentIcon({ size }: Props) {
  return (
    <svg
      viewBox="0 0 24 24"
      aria-hidden="true"
